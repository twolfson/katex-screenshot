...
process.on('unhandledRejection', function handleUncaughtRejection (err) {
  throw err;
});
...
program.action(function main (infile, outfile) {
  ...
  app.on('ready', function handleReady () {
    ...
    let browserWindow = new BrowserWindow({
      ...
      show: false,
      webPreferences: {
        // Temporary flag to silence error message for electron@11: https://github.com/electron/electron/issues/23506
