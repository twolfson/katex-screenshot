...
function handleFrame() {
  ...
  // Overload our top/height bounds as over/under decorations can get truncated
  let containerBoundsRect = containerEl.getBoundingClientRect();
  contentBounds.top = containerBoundsRect.top;
  contentBounds.height = containerBoundsRect.height;
